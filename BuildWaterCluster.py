    ...
    def getFDdat(self, step=None, units=None):
        ...
        if units == "degrees":
            if step == "0.5":
                ...
                files = [os.path.join(self.WaterDir, f"w4c_Hw{waterNum}_m1_test.fchk"),
                         os.path.join(self.WaterDir, f"w4c_Hw{waterNum}_m0_test.fchk"),
                         os.path.join(self.WaterDir, f"w4c_Hw{waterNum}.fchk"),
                         os.path.join(self.WaterDir, f"w4c_Hw{waterNum}_p0_test.fchk"),
                         os.path.join(self.WaterDir, f"w4c_Hw{waterNum}_p1_test.fchk")]
            else:
...
class BuildTetThreeOne:
    ...
    def ClusterDir(self):
        ...
        if self._ClusterDir is None:
            docs = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
            self._ClusterDir = os.path.join(docs, "stretch_bend", "tetramer_16", "three_one")
        return self._ClusterDir
    ...
    def eqfchk(self):
        if self._eqfchk is None:
            waterNum = self.isotopologue[-1]
            self._eqfchk = os.path.join(self.WaterDir, f"w4t_Hw{waterNum}.fchk")
        return self._eqfchk
    ...
    def getFDdat(self, step=None, units=None):
        ...
        if units == "degrees":
            if step == "0.5":
                files = [os.path.join(self.WaterDir, f"w4t_Hw{waterNum}_m1.fchk"),
                         os.path.join(self.WaterDir, f"w4t_Hw{waterNum}_m0.fchk"),
                         os.path.join(self.WaterDir, f"w4t_Hw{waterNum}.fchk"),
                         os.path.join(self.WaterDir, f"w4t_Hw{waterNum}_p0.fchk"),
                         os.path.join(self.WaterDir, f"w4t_Hw{waterNum}_p1.fchk")]
            elif step == "1":
                files = [os.path.join(self.WaterDir, f"w4t_Hw{waterNum}_m3.fchk"),
                         os.path.join(self.WaterDir, f"w4t_Hw{waterNum}_m1.fchk"),
                         os.path.join(self.WaterDir, f"w4t_Hw{waterNum}.fchk"),
                         os.path.join(self.WaterDir, f"w4t_Hw{waterNum}_p1.fchk"),
                         os.path.join(self.WaterDir, f"w4t_Hw{waterNum}_p3.fchk")]
            else:
                raise Exception(f"Can find data with {units} units and {step} step size.")
        else:
            raise Exception(f"Can find data with {units} units")
...
class BuildPentCage:
    ...
    def ClusterDir(self):
        ...
        if self._ClusterDir is None:
            docs = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
            self._ClusterDir = os.path.join(docs, "stretch_bend", "pentamer", "cage")
        return self._ClusterDir
...
class BuildPentRing:
    ...
    def ClusterDir(self):
        ...
        if self._ClusterDir is None:
            docs = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
            self._ClusterDir = os.path.join(docs, "stretch_bend", "pentamer", "ring")
        return self._ClusterDir
...
class BuildHexCage:
    ...
    def ClusterDir(self):
        ...
        if self._ClusterDir is None:
            docs = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
            self._ClusterDir = os.path.join(docs, "stretch_bend", "hexamer_dz", "cage")
        return self._ClusterDir
...
class BuildHexPrism:
    ...
    def ClusterDir(self):
        ...
        if self._ClusterDir is None:
            docs = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
            self._ClusterDir = os.path.join(docs, "stretch_bend", "hexamer_dz", "prism")
        return self._ClusterDir
    ...
    def getFDdat(self, step=None, units=None):
        ...
        if units == "degrees":
            if step == "0.5":
                files = [os.path.join(self.WaterDir, f"w6p_Hw{waterNum}_m1.fchk"),
                         os.path.join(self.WaterDir, f"w6p_Hw{waterNum}_m0.fchk"),
                         os.path.join(self.WaterDir, f"w6p_Hw{waterNum}.fchk"),
                         os.path.join(self.WaterDir, f"w6p_Hw{waterNum}_p0.fchk"),
                         os.path.join(self.WaterDir, f"w6p_Hw{waterNum}_p1.fchk")]
            elif step == "0.25":
                files = [os.path.join(self.WaterDir, f"w6p_Hw{waterNum}_p2_TO.fchk"),
                         os.path.join(self.WaterDir, f"w6p_Hw{waterNum}_m0_TO.fchk"),
                         os.path.join(self.WaterDir, f"w6p_Hw{waterNum}.fchk"),
                         os.path.join(self.WaterDir, f"w6p_Hw{waterNum}_p0_TO.fchk"),
                         os.path.join(self.WaterDir, f"w6p_Hw{waterNum}_p1_TO.fchk")]
            elif step == "1":
                files = [os.path.join(self.WaterDir, f"w6p_Hw{waterNum}_m3.fchk"),
                         os.path.join(self.WaterDir, f"w6p_Hw{waterNum}_m1.fchk"),
                         os.path.join(self.WaterDir, f"w6p_Hw{waterNum}.fchk"),
                         os.path.join(self.WaterDir, f"w6p_Hw{waterNum}_p1.fchk"),
                         os.path.join(self.WaterDir, f"w6p_Hw{waterNum}_p3.fchk")]
            else:
                raise Exception(f"Can find data with {units} units and {step} step size.")
        else:
            raise Exception(f"Can find data with {units} units")
