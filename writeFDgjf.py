...
if __name__ == '__main__':
    ...
    logfile = os.path.join(MoleculeDir, "w1_Opt.log")
    writeFDgjf(logfile, "w1", np.linspace(-0.0125, 0.0125, num=5, endpoint=True),
               np.linspace(-0.5, 0.5, num=5, endpoint=True), (3, 0), [(3, 1)])
